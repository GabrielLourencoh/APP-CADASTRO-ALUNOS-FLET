...
def main(page: ft.Page):
    ...
    aulas_faixa_field = ft.TextField(label="Aulas necessárias para a faixa", value="10")  
    ...
    def criar_aluno_click(e):
        aluno = {
            ...
            "aulas_necessarias_para_faixa": int(aulas_faixa_field.value),  
        }
        alunos.append(aluno)
        ...
        for aluno in alunos:
            row = ft.DataRow(
                cells=[
                    ...
                    ft.DataCell(ft.Text(str(aluno["aulas_necessarias_para_faixa"]))),  
                ]
            )
